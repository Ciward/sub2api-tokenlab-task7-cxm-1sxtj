...
func registerOpenAIOAuthRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	openai := admin.Group("/openai")
	{
		...
		openai.POST("/template-auth-url", h.Admin.OpenAIOAuth.GenerateTemplateAuthURL)
		openai.POST("/exchange-code", h.Admin.OpenAIOAuth.ExchangeCode)
		openai.POST("/refresh-token", h.Admin.OpenAIOAuth.RefreshToken)
		openai.POST("/accounts/:id/refresh", h.Admin.OpenAIOAuth.RefreshAccountToken)
		openai.POST("/accounts/:id/sync-metadata", h.Admin.OpenAIOAuth.SyncAccountMetadata)
		openai.POST("/create-from-oauth", h.Admin.OpenAIOAuth.CreateAccountFromOAuth)
		openai.POST("/create-from-template-oauth", h.Admin.OpenAIOAuth.CreateAccountFromTemplateOAuth)
	}
}
