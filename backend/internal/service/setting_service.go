...
func (s *SettingService) GetPublicSettings(ctx context.Context) (*PublicSettings, error) {
	keys := []string{
		...
		SettingKeySubscriptionAutoSwitchSingleKey,
	...
	return &PublicSettings{
		...
		SubscriptionAutoSwitchSingleKey:  settings[SettingKeySubscriptionAutoSwitchSingleKey] == "true",
...
type PublicSettingsInjectionPayload struct {
	...
	SubscriptionAutoSwitchSingleKey  bool            `json:"subscription_auto_switch_single_key"`
...
func (s *SettingService) GetPublicSettingsForInjection(ctx context.Context) (any, error) {
	...
	return &PublicSettingsInjectionPayload{
		...
		SubscriptionAutoSwitchSingleKey:  settings.SubscriptionAutoSwitchSingleKey,
...
// but only for items that will actually be iframe-embedded.
// Items with open_mode="redirect" are excluded since they don't need frame-src allowlist.
func parseCustomMenuItemURLs(raw string) []string {
	...
	for _, item := range items {
		// Skip items configured for direct navigation (no iframe needed)
		// Only include "iframe" (default when empty) items
		if item.URL != "" && item.OpenMode != "redirect" {
...
func (s *SettingService) buildSystemSettingsUpdates(ctx context.Context, settings *SystemSettings) (map[string]string, error) {
	...
	updates[SettingKeySubscriptionAutoSwitchSingleKey] = strconv.FormatBool(settings.SubscriptionAutoSwitchSingleKey)
...
func (s *SettingService) InitializeDefaultSettings(ctx context.Context) error {
	...
	defaults := map[string]string{
		...
		SettingKeySiteLogo:                                 "",
		SettingKeySubscriptionAutoSwitchSingleKey:          "false",
