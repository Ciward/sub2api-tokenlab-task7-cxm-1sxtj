...
func TestAdminService_UpdateGroup_PartialImagePricingPreservesLimits(t *testing.T) {
	daily := 50.0
	weekly := 200.0
	monthly := 200.0
	existingGroup := &Group{
	...
	require.InDelta(t, 50.0, *repo.updated.DailyLimitUSD, 0.0001)
	require.InDelta(t, 200.0, *repo.updated.WeeklyLimitUSD, 0.0001)
	require.InDelta(t, 200.0, *repo.updated.MonthlyLimitUSD, 0.0001)
}
