...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	subscriptionKeySwitchCoordinator := service.NewSubscriptionKeySwitchCoordinator(apiKeyRepository, groupRepository, settingRepository, apiKeyAuthCacheInvalidator)
	redeemCache := repository.NewRedeemCache(redisClient)
	redeemService := service.NewRedeemService(redeemCodeRepository, userRepository, subscriptionService, subscriptionKeySwitchCoordinator, affiliateService, redeemCache, billingCacheService, client, apiKeyAuthCacheInvalidator)
	...
	paymentService := service.NewPaymentService(client, registry, defaultLoadBalancer, redeemService, subscriptionService, subscriptionKeySwitchCoordinator, paymentConfigService, userRepository, groupRepository, affiliateService)
