          ...
          <div class="card">
            ...
            <div class="space-y-6 p-6">
              ...
              >
                <div>
                  <label class="font-medium text-gray-900 dark:text-white">{{
                    t("admin.settings.site.subscriptionAutoSwitchSingleKey")
                  }}</label>
                  <p class="text-sm text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.site.subscriptionAutoSwitchSingleKeyHint") }}
                  </p>
                </div>
                <Toggle v-model="form.subscription_auto_switch_single_key" />
              </div>
            </div>
          </div>
              ...
              >
                ...
                <div class="grid grid-cols-1 gap-3 sm:grid-cols-2">
                  ...
                  <div>
                    ...
                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                      {{
                        item.open_mode === "redirect"
                          ? t("admin.settings.customMenu.openModeRedirectHint")
                          : t("admin.settings.customMenu.openModeIframeHint")
                      }}
                    </p>
                  </div>
...
> & {
  ...
  subscription_auto_switch_single_key: boolean;
...
const form = reactive<SettingsForm>({
  ...
  subscription_auto_switch_single_key: false,
...
function addMenuItem() {
  form.custom_menu_items.push({
    ...
    open_mode: "iframe", // Default to iframe embedding (backward compatible)
  });
}
...
async function loadSettings() {
  ...
  try {
    ...
    // Normalize custom_menu_items: ensure open_mode defaults to 'iframe' for backward compatibility
    // with existing data that doesn't have this field.
...
async function saveSettings() {
  ...
  try {
    ...
    const payload: UpdateSettingsRequest = {
      ...
      subscription_auto_switch_single_key: form.subscription_auto_switch_single_key,
