                ...
                <div class="mt-2 text-sm text-emerald-700 dark:text-emerald-400">
                  ...
                  <div class="mt-3 space-y-1">
                    ...
                    <p v-else-if="redeemResult.type === 'subscription'" class="font-medium">
                      ...
                      <span v-if="redeemResult.group?.name || redeemResult.group_name"> - {{ redeemResult.group?.name || redeemResult.group_name }}</span>
...
const redeemResult = ref<{
  ...
  subscription_key_switch?: SubscriptionKeySwitchResult
} | null>(null)
const errorMessage = ref('')
const subscriptionKeySwitchDialogVisible = ref(false)
const subscriptionKeySwitchResult = ref<SubscriptionKeySwitchResult | null>(null)
...
function closeSubscriptionKeySwitchDialog() {
  subscriptionKeySwitchDialogVisible.value = false
}

async function goToKeysAfterRedeem() {
...
const handleRedeem = async () => {
  ...
  try {
    ...
    if (result.subscription_key_switch && result.subscription_key_switch.action !== 'none') {
      subscriptionKeySwitchResult.value = result.subscription_key_switch
