export default {
  ...
  keys: {
    ...
    useKeyModal: {
      ...
      openclaw: {
        description: 'Configure TokenLab directly in openclaw.json. You no longer need a separate auth-profiles.json or environment variable for this setup.',
        note: 'The recommended setup is now a single openclaw.json configuration. Merge the example below into your existing file; it already includes the TokenLab provider, API key, and default model example.',
        noteWindows: 'The recommended setup is now a single openclaw.json configuration. Merge the example below into your existing file. Windows paths are shown with %userprofile%. No separate auth-profiles.json or environment variable is required.',
        envHint: 'No extra environment variable is required.',
        configHint: 'This is a complete openclaw.json example snippet. Merge it into your existing config.',
        authProfilesHint: 'No separate auth-profiles.json file is required.',
      },
      antigravity: {
  ...
  subscriptionKeySwitch: {
    autoTitle: 'Your subscription group was switched automatically',
    manualTitle: 'Switch your API key to the new subscription group',
    noKeyTitle: 'Create or switch an API key to the new subscription group',
    autoDescription: 'You just received the {groupName} subscription. We automatically switched your only API key "{keyName}" to that subscription group.',
    manualDescription: 'You just received the {groupName} subscription. Please go to the API Keys page and switch the key you want to use to that subscription group, otherwise requests may continue consuming your balance.',
    noKeyDescription: 'You just received the {groupName} subscription. Please go to the API Keys page to create a new key or switch an existing key to that subscription group, otherwise requests may continue consuming your balance.',
    goToKeys: 'Go to API Keys',
    warning: 'If you do not switch to the matching subscription group, requests may still be billed against your balance.',
    defaultGroupName: 'your new subscription group',
    singleKeyFallbackName: 'default API key'
  },
  ...
  admin: {
    ...
    accounts: {
      ...
      openai: {
        ...
        templateLabel: 'Which template to use',
        templateNone: 'Do not use a template (manual configuration)',
        templateLoading: 'Loading available template accounts…',
        templateHint: 'When a template is selected, the new account will inherit proxy, groups, billing multiplier, model mappings, and OpenAI strategy settings from that account. Manual configuration blocks below will be hidden.',
        templateUsing: 'Using template account: {name}',
      },
      anthropic: {
    ...
    settings: {
      ...
      site: {
        ...
        subscriptionAutoSwitchSingleKey: 'Auto-switch group for single-key users after new subscriptions',
        subscriptionAutoSwitchSingleKeyHint:
          'When enabled, users who acquire a new subscription and only have one API key will have that key switched automatically to the subscription group; otherwise they only receive a reminder dialog.'
      },
      purchase: {
      ...
      customMenu: {
        ...
        description: 'Add custom pages to the sidebar navigation. Each page can be visible to regular users or administrators. External sites that block iframe embedding should use "Direct redirect" mode.',
        ...
        openModeIframeHint: 'Open within the app via iframe. Good for internal pages that support embedding.',
        openModeRedirect: 'Direct redirect',
        openModeRedirectHint: 'Open directly in a new window. For external sites that block iframe embedding.',
        add: 'Add Menu Item',
        remove: 'Remove',
        moveUp: 'Move Up',
        moveDown: 'Move Down',
  ...
  customPage: {
    ...
    redirectHint: 'This page is configured for direct redirect mode. Click the button below to visit it.',
