...
import type {
  ...
  CreateOrderResult,
  PaymentOrder,
  PaymentSubscriptionKeySwitchResult
} from '@/types/payment'
...
export const paymentAPI = {
  ...
  /** Get the post-subscription API key switch result for an order */
  getSubscriptionKeySwitchResult(id: number) {
    return apiClient.get<PaymentSubscriptionKeySwitchResult>(`/payment/orders/${id}/subscription-key-switch`)
  },
